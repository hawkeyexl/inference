...
For using them, see [judge and consensus](/inference/judge/).
...
<Aside type="tip" title="schema is the per-consumer override">
  ...
  [custom verdict schema](/inference/judge/verdict-schema/).
</Aside>
...
<Aside type="danger" title="JudgeRun is a file format">
  ...
  [upgrading](/inference/keep-it-working/upgrading/).
</Aside>
